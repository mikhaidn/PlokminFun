...
1. Should Phase 4 (puzzle maker) precede Phase 3 (local versus)? Puzzle mode may have broader solo appeal; order is swappable — only Phase 5 hard-depends on 3
2. Does RFC-006 want to adopt this RFC's URL envelope (deflate+base64url fragment) as its general format?
3. Ship name (D5) still needs an owner decision before the Phase 2 landing-page entry
