  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'Spider',
        description: 'Classic Spider Solitaire game - playable offline',
        theme_color: '#1e40af',
        background_color: '#1e40af',
        display: 'standalone',
        orientation: 'portrait',
        scope: '/PlokminFun/spider/',
        start_url: '/PlokminFun/spider/',
        icons: [
          {
            src: '/PlokminFun/spider/icon-192.png',
            sizes: '192x192',
            type: 'image/png',
            purpose: 'any maskable',
          },
          {
            src: '/PlokminFun/spider/icon-512.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'any maskable',
          },
